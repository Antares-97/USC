...
class techVC: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        delay(seconds: 0.1) {
            SwiftSpinner.show(duration: 3.0, title: "Loading TECHNOLOGY Headlines..")
        }
        self.configureTableView()
        fetchSectionNews(section: "technology")
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "techNewsCell", for: indexPath) as! NewsTableViewCell
...
extension techVC: IndicatorInfoProvider {
