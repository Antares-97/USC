...
class businessVC: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        fetchSectionNews(section: "business")
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "businessNewsCell", for: indexPath) as! NewsTableViewCell
...
extension businessVC: IndicatorInfoProvider {
