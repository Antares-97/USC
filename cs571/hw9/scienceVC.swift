...
class scienceVC: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        fetchSectionNews(section: "science")
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "scienceNewsCell", for: indexPath) as! NewsTableViewCell
...
extension scienceVC: IndicatorInfoProvider {
