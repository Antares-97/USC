...
class sportsVC: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        fetchSectionNews(section: "sport")
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "sportsNewsCell", for: indexPath) as! NewsTableViewCell
...
extension sportsVC: IndicatorInfoProvider {
