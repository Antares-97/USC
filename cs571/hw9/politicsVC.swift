...
class politicsVC: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        fetchSectionNews(section: "politics")
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "politicsNewsCell", for: indexPath) as! NewsTableViewCell
...
extension politicsVC: IndicatorInfoProvider {
